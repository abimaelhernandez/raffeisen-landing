            ...
            <div className="modal-dialog modal-sm mt-modal">
              <div className="modal-content">
                ...
                <div className="modal-body d-flex justify-content-around">
                  <FacebookShareButton quote={messages[locale].learnMore} url="https://stark-savannah-38095.herokuapp.com/">
                    <FacebookIcon size={32} />
                  </FacebookShareButton>
                  <TwitterShareButton title={messages[locale].learnMore} url="https://stark-savannah-38095.herokuapp.com/">
                    <TwitterIcon size={32} />
                  </TwitterShareButton>
                  <WhatsappShareButton title={messages[locale].learnMore} url="https://stark-savannah-38095.herokuapp.com/">
